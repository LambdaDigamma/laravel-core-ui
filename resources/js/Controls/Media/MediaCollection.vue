<template>
    <media-library-renderless
        ...
        :translations="{
            fileTypeNotAllowed: 'Der Upload erfordert eine Datei des Typs',
            tooLarge: 'Datei zu groß, max',
            tooSmall: 'Datei zu klein, min',
            tryAgain: 'Bitte versuche, diese Datei erneut hochzuladen',
            somethingWentWrong: 'Etwas ist beim hochladen schiefgegangen',
            selectOrDrag: 'Dateien auswählen oder ziehen',
            selectOrDragMax: 'Wählt oder bewege max {maxItems} {file}',
                ...
                >
                    ...
                    <template v-else>
                        <slot name="properties" :object="object">
                            <div
                                class=" media-library-properties media-library-properties-fixed"
                            >
                                <div
                                ...
                                <div
                                    v-if="object.attributes.original_url"
                                    class="media-library-property"
                                >
                                    <a
...
import {
    ...
    Thumb,
    Uploader,
} from "media-library-pro-vue3";

export default {
    props: {
        name: { required: false, type: String },
        modelValue: { required: false, type: [Array, Object] },
