<template>
    <component
        class="inline-flex items-center font-medium text-red-700 transition duration-150 ease-in-out bg-red-100 border border-transparent"
        :is="type"
        :href="href"
        :type="buttonType"
        :class="{
            ...
            'hover:bg-red-50 focus:outline-none focus:border-red-300 focus:ring-red active:bg-red-200': !disabled,
            'opacity-50': disabled,
        }"
